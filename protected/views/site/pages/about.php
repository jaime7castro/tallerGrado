...
<center><h1>ÁREA NAVAL No. 2 SC</h1></center>
        ...
        <div class="AN1">
            <p>El Área Naval No.  2 de Santa Cruz de la Sierra es parte de las 
            Unidades Navales de la Armada Boliviana. Actualmente el 
            Comandante de la Unidad es el CN. DAEN. Marcelino Pedraza Arana
            (Armada Boliviana, 2014).</p>
            
            <center>
            <img src="images/an2.jpg" alt="Edificio del área Naval No. 2"/>
            </center>
            <center><p><i>Edificio del área Naval No. 2</i></p></br></center>
            <ul>
                <li><h4>Efeméride</h4></li>
            </ul>
            <p>28 de Mayo.</p>
            <ul>
                <li><h4>Creación</h4></li>
            </ul>
            ...
            <center>
            <img src="images/heraldica.jpg" alt="Heráldica del área Naval No. 2"/>
            </center>
            
            <center><p><i>Heráldica del área Naval No. 2</i></p></br></center>
            
            <ul>
                <li><h4>Unidades Dependientes</h4>
                    <ul>
                        <li>Batallón de Policía Naval No. 3</li>
                        <li>Base Naval Ramón Darío Gutiérrez</Li>
                    </ul>
                </li>
            </ul>
            <ul>
                <li><h4>Reseña Histórica</h4></li>
            </ul>
